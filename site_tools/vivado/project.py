...
def synth_vivado_project(target, source, env):
    ...
    text += r'    error "\[XILINX_PRJ_BUILD:ERROR\] synth_1 failed"'            + os.linesep
    text += '} else {'                                                          + os.linesep
    text += r'    puts "\[XILINX_PRJ_BUILD:INFO\] synth_1 completed. Ok."'      + os.linesep
    text += '}'                                                                 + os.linesep
...
def impl_vivado_project(target, source, env):
    ...
    text += r'    error "\[XILINX_PRJ_BUILD:ERROR\] impl_1 failed"'             + os.linesep
    text += '} else {'                                                          + os.linesep
    text += r'    puts "\[XILINX_PRJ_BUILD:INFO\] impl_1 completed. Ok."'       + os.linesep
    text += '}'                                                                 + os.linesep
